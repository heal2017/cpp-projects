...
// 解析infoList
std::map<std::string, boost::variant<int, double, std::string, std::vector<std::string>>> InCAM::parseInfo(const std::vector<std::string>& infoList) {
...
// std::map<std::string, boost::variant<int, double, std::string, std::vector<std::string>>> InCAM::DO_INFO(const std::string& args) {
//     std::list<std::string> lines;
//     COM("info,out_file=" + tmpfile + ",write_mode=replace,args=" + args);
//     std::ifstream file(tmpfile);
//     if (!file) {
